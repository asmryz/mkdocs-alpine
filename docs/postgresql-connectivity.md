...
Learn how to run SQL queries in Neon from JavaScript using pg, postgres.js, or the Neon serverless driver

Pre-built prompt for connecting JavaScript applications to Neon [View prompt](https://neon.com/prompts/javascript-prompt.md)
...
**Important: Connect from the Server-Side Only**
...
1. Create a project directory and initialize it with `npm`.
